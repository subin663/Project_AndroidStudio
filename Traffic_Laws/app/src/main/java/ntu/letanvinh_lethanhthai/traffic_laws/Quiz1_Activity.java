...
public class Quiz1_Activity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (questionList != null) {
            ...
            startQuizTimer(); // Start the timer when the quiz loads
        ...
        submitButton.setOnClickListener(v -> submitQuiz()); // Call submitQuiz when button is clicked
    }
    ...
    private void submitQuiz() {
        if (countDownTimer != null) {
            countDownTimer.cancel(); // Stop the timer when quiz is submitted
        }
        ...
        finish(); // Finish the activity after submitting the quiz
    }
